solution 'utilities'
    ...
    project 'evt2_to_es'
        ...
        language 'C++'
        location 'build'
        files {'source/evt.hpp', 'source/evt2_to_es.cpp'}
        configuration 'release'
            targetdir 'build/release'
            defines {'NDEBUG'}
            flags {'OptimizeSpeed'}
    ...
    project 'evt3_to_es'
        ...
        language 'C++'
        location 'build'
        files {'source/evt.hpp', 'source/evt3_to_es.cpp'}
        configuration 'release'
            targetdir 'build/release'
            defines {'NDEBUG'}
            flags {'OptimizeSpeed'}
